...
<div class="container mt-4">
    ...
    <form action="{{ route('superadmin.pasien.update', $patient->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            @if ($patient->photo)
                <img src="{{ asset('storage/' . $patient->photo) }}" alt="Patient Photo" width="100" class="mt-2 rounded">
            @endif
        </div>
